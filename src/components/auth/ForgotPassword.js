      ...
      <div className="max-w-md w-full">
        <div className="bg-white rounded-2xl shadow-xl p-8 space-y-8">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            {message && (
              <div className="border-l-4 p-4 rounded-r-lg" style={{ backgroundColor: '#f0fffe', borderColor: '#28b4b4' }}>
                <div className="flex">
                  <svg className="h-5 w-5" style={{ color: '#28b4b4' }} viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <p className="ml-3 text-sm" style={{ color: '#28b4b4' }}>{message}</p>
                </div>
              </div>
            )}
